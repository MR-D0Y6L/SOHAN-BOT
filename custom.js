  ...
  cron.schedule('*/10 * * * *', () => {
    ...
    api.getThreadList(25, null, ['INBOX'], async (err, data) => {
      ...
      async function message(thread) {
        try {
          api.sendMessage({
            body: `⟩ Thank you for using SOHAN-BOT!\n\n⟩ Fork Here: https://replit.com/@YanMaglinte/SOHAN-BOT\n\n⟩ For your concerns about the Repl, kindly add and follow me on FB: https://www.facebook.com/Mohammad.s0h4n`
          }, thread.threadID, (err) => {
            if (err) return;
